...
const Nav = ({dataNav}) => {
  const { dataIcon, searchData, seoData } = useHeader();
  ...
  console.log(dataNav, "dataNav header");
          ...
          >
            <div className="flex justify-between items-center w-full ml-[30%]">
              <ol className="inline-flex items-center space-x-2 lg:space-x-4">
                {dataNav?.newMenuLocationItems?.edges.map(
                  (item) => (
                    console.log(item.node.label, "item"),
                    (
                      <>
                        <li>
            ...
            <>
              ...
              <div className="flex justify-center lg:justify-start items-center">
                <div className="relative mx-2 md:mx-5 hidden lg:block">
                  ...
                  >
                    {dataNav?.primaryMenuItems?.edges[0].node?.label}
                    <Image
                      priority={true}
                      loader={customLoader}
                ...
                <Link
                  href={dataNav?.primaryMenuItems?.edges[4].node?.uri ?? "/"}
      ...
      {isDropdownOpen && (
        <div className="bg-white font-medium inline-flex items-center md:ml-80">
          <div className="flex flex-col items-center">
            <Link
              href={
                dataNav?.primaryMenuItems?.edges[1]?.node?.uri !== null
                  ? dataNav?.primaryMenuItems?.edges[1]?.node?.uri
                  : "/"
              }
              className={`breaking_news px-4 text-gray-800 hover:bg-gray-100 ${
                activeLink === dataNav?.primaryMenuItems?.edges[1]?.node?.uri ||
                router.asPath === dataNav?.primaryMenuItems?.edges[1].node?.uri
                  ? "border-b-3 bg-change2"
                  : ""
              }`}
              onClick={() =>
                toggleDropdown(dataNav?.primaryMenuItems?.edges[1].node?.uri)
              }
            >
              {dataNav?.primaryMenuItems !== undefined &&
          ...
          <div className="flex flex-col items-center">
            <Link
              href={
                dataNav?.primaryMenuItems?.edges[2].node?.uri !== null
                  ? dataNav?.primaryMenuItems?.edges[2].node?.uri
                  : "/"
              }
              className={`politics px-4 text-gray-800 hover:bg-gray-100 ${
                activeLink === dataNav?.primaryMenuItems?.edges[2].node?.uri ||
                router.asPath === dataNav?.primaryMenuItems?.edges[2].node?.uri
          ...
          <div className="flex flex-col items-center">
            <Link
              href={
                dataNav?.primaryMenuItems?.edges[3].node?.uri !== null
                  ? dataNav?.primaryMenuItems?.edges[3].node?.uri
                  : "/"
              }
              className={`px-4 text-gray-800 hover:bg-gray-100 ${
                activeLink === dataNav?.primaryMenuItems?.edges[3].node?.uri ||
                router.asPath === dataNav?.primaryMenuItems?.edges[3].node?.uri
